...
begin
     ...
     // <--- Added By Alexander Chen -->
     // 岆祥岆傷諳瘍湮衾 COM9
     // Whether the Port Name is greater than COM9
     if (Length(FCommName) > 4) and (AnsiStartsText('COM', FCommName)) then
        sFileName := '\\.\' + FCommName
     else
        sFileName := FCommName;
     // <--- END MODIFIED -->

     hNewCommFile := CreateFile( PChar(sFileName),
...
procedure Register;
begin
     RegisterComponents('Custom', [TComm])
end;
