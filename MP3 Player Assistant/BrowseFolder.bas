...
Public Function BrowseForFolder(hWnd As Long, Title As String, StartDir As String, Optional ByVal RootMode As Boolean = False, Optional ByVal RootDir As String) As String
  ...
  If RootMode Then .pIDLRoot = lstrcat(RootDir, "")
